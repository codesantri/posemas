...
<div class="w-[360px]  flex flex-col">
    ...
    <div class="border-t border-gray-200 px-6 py-5">
        ...
        <x-filament::button type="submit"
            class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
            Proses Pembayaran
        </x-filament::button>
