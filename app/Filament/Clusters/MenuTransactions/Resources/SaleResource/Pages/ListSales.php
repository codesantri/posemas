...
class ListSales extends ListRecords
{
    ...
    protected static string $view = 'filament.clusters.menu-transactions.resources.sales-resource.list-sales';
    ...
    {
        $this->redirect(route('filament.admin.menu-transactions.resources.sales.cart'));
    }
}
