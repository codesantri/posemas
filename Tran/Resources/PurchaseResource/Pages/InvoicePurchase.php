...
class InvoicePurchase extends Page implements HasForms
{
    ...
    protected static string $view = 'filament.clusters.transactions.resources.purchase-resource.invoice-purchase';
    ...
    public function redirectBack($record)
    {
        if ($record->status == 'success') {
            // redirect()->route('filament.admin.transactions.resources.purchases.index');
        }
    }
